...
class Autoencoder(nn.Module):
    ...
    def plot_psnr_ssim(self):
        ...
        axes[0].plot(self.validation_psnr_values, label='Validation Loss')
        ...
        axes[2].plot(self.validation_psnr_values, label='Validation SSIM')
    ...
    def show_lowest_psnr_ssim_image(self, image_set, lowest_psnr, lowest_ssim):
        ...
        _, decoded = self(psnr_image_tensor)
        decoded = decoded.view(-1, self.height, self.width)  # Reshape decoded images
        ...
        _, decoded = self(ssim_image_tensor)
        decoded = decoded.view(-1, self.height, self.width)  # Reshape decoded images
